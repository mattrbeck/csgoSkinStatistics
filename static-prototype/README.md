...
static-prototype/
  ...
  site/
    index.html        # single-item page
    app.js            # wiring + per-item network panel + idle prefetch
    ...
    loader.js         # manifest-driven shard loader: balanced-range binary search + prefetch
    styles.css
